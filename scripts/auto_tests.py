...
MODELING_QWEN3_5_TEXT_MTP_N3_ARGS = [
    "--cache-model",
    "--mode",
    "text",
    "--mtp",
...
TEST_SPECS: List[Dict[str, Any]] = [
    ...
    # ---------------------------------------------------------------------------
    # Non-MTP greedy baseline (temperature=0) for output correctness comparison
    # ---------------------------------------------------------------------------
    {
        "name": "Huggingface Qwen3.5-2B modeling_qwen3_5 text greedy baseline",
        "model_rel": Path("Huggingface") / "Qwen3.5-2B",
        "exe_rel": MODELING_QWEN3_5_EXE_REL,
        "work_dir_rel": TEXT_WORK_DIR_REL,
        "command_args": [
            "--cache-model", "--mode", "text",
            "--temperature", "0",
            "--prompt", PROMPT,
            "--output-tokens", "300",
        ],
    ...
    # ---------------------------------------------------------------------------
    # MTP N=3 (phase-2) speculative decoding tests
    # Drafts 3 tokens per super-step with batched main-model verification.
    # ---------------------------------------------------------------------------
    {
        "name": "Huggingface Qwen3.5-35B-A3B modeling_qwen3_5 text MTP N=3 greedy",
        "model_rel": Path("Huggingface") / "Qwen3.5-35B-A3B",
        "exe_rel": MODELING_QWEN3_5_EXE_REL,
        "work_dir_rel": TEXT_WORK_DIR_REL,
        "command_args": MODELING_QWEN3_5_TEXT_MTP_N3_ARGS.copy(),
        "extra_env": QWEN3_5_35B_EXTRA_ENV.copy(),
        "use_named_model_arg": True,
    },
    {
        "name": "Huggingface Qwen3.5-2B modeling_qwen3_5 text MTP N=3 greedy",
        "model_rel": Path("Huggingface") / "Qwen3.5-2B",
        "exe_rel": MODELING_QWEN3_5_EXE_REL,
        "work_dir_rel": TEXT_WORK_DIR_REL,
        "command_args": MODELING_QWEN3_5_TEXT_MTP_N3_ARGS.copy(),
        # Same extra_env as existing 2B N=1 test [46]
        "extra_env": QWEN3_5_35B_EXTRA_ENV.copy(),
        "use_named_model_arg": True,
    },
]
